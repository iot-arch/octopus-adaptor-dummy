...
func init() {
	// calculate the project dir of ${GOPATH}/github.com/iot-arch/adaptors/dummy/octopus/test/e2e/installation
	testCurrDir, _ = filepath.Abs(filepath.Join(filepath.Dir("."), "..", "..", ".."))
	// calculate the project root dir of ${GOPATH}/github.com/iot-arch/adaptors/dummy/octopus/test/e2e/installation
