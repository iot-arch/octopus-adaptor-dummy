...
import (
	...
	"github.com/iot-arch/adaptors/dummy/octopus/pkg/adaptor/api/v1alpha1"
	mock_v1alpha1 "github.com/iot-arch/adaptors/dummy/octopus/pkg/adaptor/api/v1alpha1/mock"
)
